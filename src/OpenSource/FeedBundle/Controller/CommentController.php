...
class CommentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('OpenSourceFeedBundle:Comment')->findAll();
     ...
     * @Method("POST")
     * @Template("OpenSourceFeedBundle:Comment:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('OpenSourceFeedBundle:Comment')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("OpenSourceFeedBundle:Comment:edit.html.twig")
     */
